...
const NxModal = (props) => {
  ...
  return (
    <Modal
      ...
      footer={footer}
      className={`[&_.ant-modal-content]:overflow-hidden [&_.ant-modal-content]:border [&_.ant-modal-content]:border-solid [&_.ant-modal-content]:border-[#C8CDD4] [&_.ant-modal-content]:rounded-lg [&_.ant-modal-body]:p-0 [&_.ant-modal-footer]:border-t [&_.ant-modal-footer]:border-[#C8CDD4] ${className}`}
      centered={centered}
      width={width}
