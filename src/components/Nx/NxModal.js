...
const NxModal = ({
  ...
  return (
    <Modal
      ...
      footer={footer}
      className={`[&_.ant-modal-header]:p-4 [&_.ant-modal-header]:border-0 [&_.ant-modal-header]:border-b [&_.ant-modal-header]:border-solid [&_.ant-modal-header]:border-[#C8CDD4] [&_.ant-modal-title]:uppercase [&_.ant-modal-title]:font-normal [&_.ant-modal-header]:bg-[#F5F5F5] [&_.ant-modal-title]:text-[#0075bf] [&_.ant-modal-content]:overflow-hidden [&_.ant-modal-content]:border [&_.ant-modal-content]:border-solid [&_.ant-modal-content]:border-[#C8CDD4] [&_.ant-modal-content]:rounded-lg [&_.ant-modal-body]:p-0 [&_.ant-modal-footer]:p-4 [&_.ant-modal-footer]:border-t [&_.ant-modal-footer]:border-[#C8CDD4] ${className}`}
      centered={centered}
      width={width}
