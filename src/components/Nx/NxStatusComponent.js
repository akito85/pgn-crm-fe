...
const NxStatusComponent = ({
  ...
  return (
    <div
      className={`flex gap-2 rounded-3xl ${bgcolor} ${textColor} text-xs px-2 leading-normal text-center w-fit`}
    >
      {/* {renderIconStatus()} */}
      {toTitleCase(children.replace(/_/g, " "))}
    </div>
  );
};

export default NxStatusComponent;
