...
export const useContactHooks = (
  ...
  const displayActionButton = useCallback(
    (record, buttons) => {
              ...
              <div className="flex w-full justify-center gap-6">
                {lowerCaseButton?.includes("detail") && (
                  <Tooltip title="Detail">
                    <div
                      onClick={
                        editable === false && (() => handleDetail(record))
                      }
                    >
                ...
                {lowerCaseButton?.includes("update") && (
                  <Tooltip title="Edit">
                    <div
                      ...
                      onClick={
                        !editingKey ? () => handleUpdate(record) : undefined
                      }
                    >
                      <SVGIcon
                        name="IconEdit"
                ...
                {(lowerCaseButton?.includes("inactivate") ||
                  lowerCaseButton?.includes("inactive")) && (
