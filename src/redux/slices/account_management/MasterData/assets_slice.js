...
const assetsSlice = createSlice({
  ...
  extraReducers: {
    // pagination
    [getAssetsPaginate.pending]: (state) => {
      state.loading = true;
    },
    [getAssetsPaginate.rejected]: (state) => {
      state.loading = false;
    },
    ...
    // download
    [downloadAssets.pending]: (state) => {
      state.loading = true;
    },
    [downloadAssets.rejected]: (state) => {
      state.loading = false;
    },
    [downloadAssets.fulfilled]: (state) => {
      state.loading = false;
    },
    // detail
    [getDetailAssets.pending]: (state) => {
      state.loading = true;
    },
    [getDetailAssets.rejected]: (state) => {
      state.loading = false;
    },
    ...
    // update
    [updateAsstes.pending]: (state) => {
      state.loading = true;
    },
    [updateAsstes.rejected]: (state) => {
      state.loading = false;
    },
    ...
    // activation
    [activationAssets.pending]: (state) => {
      state.loading = true;
    },
    [activationAssets.rejected]: (state) => {
      state.loading = false;
      // state.data = action.payload;
    },
    [activationAssets.fulfilled]: (state) => {
      state.loading = false;
      // state.data = action.payload;
    },

    // get list ddl asset name
    [getListAssetName.pending]: (state) => {
      state.loading = true;
    },
    ...
    [getListAssetType.pending]: (state) => {
      state.loading = true;
    },
    ...
    [getListAssetBrand.pending]: (state) => {
      state.loading = true;
    },
    ...
    [getListAssetServiceType.pending]: (state) => {
      state.loading = true;
    },
    ...
    [getListProductName.pending]: (state) => {
      state.loading = true;
    },
    ...
    [getListServicePointName.pending]: (state) => {
      state.loading = true;
    },
