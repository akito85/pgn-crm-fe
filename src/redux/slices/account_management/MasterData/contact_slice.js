...
const contactSlice = createSlice({
  ...
  extraReducers: {
    // pagination
    [getContactPaginate.pending]: (state) => {
      state.loading = true;
    },
    [getContactPaginate.rejected]: (state) => {
      state.loading = false;
    },
    ...
    // download
    [downloadContact.pending]: (state) => {
      state.loading = true;
    },
    [downloadContact.rejected]: (state) => {
      state.loading = false;
    },
    [downloadContact.fulfilled]: (state) => {
      state.loading = false;
      // state.data = action.payload;
    },
    // detail
    [getDetailContact.pending]: (state) => {
      state.loading = true;
    },
    ...
    // activation
    [activationContact.pending]: (state) => {
      state.loading = true;
    },
    [activationContact.rejected]: (state) => {
      state.loading = false;
    },
    [activationContact.fulfilled]: (state) => {
      state.loading = false;
      // state.data = action.payload;
    },
    // get ddl job
    ...
    // get input type
    [getInputType.pending]: (state) => {
      state.loading = true;
    },
    [getInputType.rejected]: (state) => {
      state.loading = false;
    },
    ...
    // get contact type
    [getContactType.pending]: (state) => {
      state.loading = true;
    },
    [getContactType.rejected]: (state) => {
      state.loading = false;
    },
    ...
    // get contact type
    [getCountryCode.pending]: (state) => {
      state.loading = true;
    },
    [getCountryCode.rejected]: (state) => {
      state.loading = false;
    },
