...
export const getJobById = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      ...
      console.log('GetJobById Response:', response);
...
export const getListParentJob = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      ...
      console.log('Parent Job Response:', response);
  ...
  async (data, thunkAPI) => {
    try {
      const payload = {
        ...
        cancelParentId: data.cancel_parent_id ? parseInt(data.cancel_parent_id) : null,
      ...
      const response = await userHttpService.createData(url, payload, NGROK_BASE_URL);
