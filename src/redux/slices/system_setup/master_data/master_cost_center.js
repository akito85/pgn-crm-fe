...
const masterCostCenterSlice = createSlice({
  ...
  extraReducers: {
    ...
    [getSiblingDetail.rejected]: (state, action) => {
      state.loading = false;
    },

    // Activate cost center
    [activateCostCenter.pending]: (state, action) => {
      state.loading = true;
    },
    [activateCostCenter.fulfilled]: (state, action) => {
    ...
    // download
    [downloadMasterCostCenter.pending]: (state, action) => {
      state.loading = true;
    },
    [downloadMasterCostCenter.fulfilled]: (state, action) => {
      // state.data = action.payload;
      state.loading = false;
    },
    [downloadMasterCostCenter.rejected]: (state, action) => {
      // state.data = action.payload;
      state.loading = false;
    },
  },
