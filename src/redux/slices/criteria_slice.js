...
export const getSelectCriteria = createAsyncThunk(
    ...
    async ({ services, urls }, thunkAPI) => {
        try {
            ...
            thunkAPI.dispatch(
                validateError({ error: error, action: "GET_SELECT_CRITERIA", back: false })
            );
...
export const getAccountCategory = createAsyncThunk(
    ...
    async ({ services, urls }, thunkAPI) => {
        try {
            ...
            thunkAPI.dispatch(
                validateError({ error: error, action: "GET_ACCOUNT_CATEFORY", back: false })
            );
            return thunkAPI.rejectWithValue([]);
        }
    }
...
export const getAccountGroupType = createAsyncThunk(
    ...
    async ({ services, urls, id }, thunkAPI) => {
        try {
            ...
            thunkAPI.dispatch(
                validateError({ error: error, action: "GET_ACCOUNT_GROUP_TYPE", back: false })
            );
            return thunkAPI.rejectWithValue([]);
        }
    }
...
export const getIndustrialSector = createAsyncThunk(
    ...
    async ({ services, urls }, thunkAPI) => {
        try {
            ...
            thunkAPI.dispatch(
                validateError({ error: error, action: "GET_INDUSTRIAL_SECTOR", back: false })
            );
            return thunkAPI.rejectWithValue([]);
        }
    }
...
export const getCustomerSegment = createAsyncThunk(
    ...
    async ({ services, urls }, thunkAPI) => {
        try {
            ...
            thunkAPI.dispatch(
                validateError({ error: error, action: "GET_CUSTOMER_SEGMENT", back: false })
            );
            return thunkAPI.rejectWithValue([]);
        }
    }
...
export const getAccountNumber = createAsyncThunk(
    ...
    async ({ services, urls }, thunkAPI) => {
        try {
            ...
            thunkAPI.dispatch(
                validateError({ error: error, action: "GET_ACCOUNT_NUMBER", back: false })
            );
            return thunkAPI.rejectWithValue([]);
        }
    }
...
export const getAccountSegment = createAsyncThunk(
    ...
    async ({ services, urls }, thunkAPI) => {
        try {
            ...
            thunkAPI.dispatch(
                validateError({ error: error, action: "GET_ACCOUNT_SEGMENT", back: false })
            );
            return thunkAPI.rejectWithValue([]);
        }
    }
...
const criteriaSlice = createSlice({
    ...
    reducers: {
        ...
        resetAllStateCriteria: (state, action) => {
    ...
    extraReducers: {
        ...
        [getBudgetType.pending]: (state, action) => {
            state.loading_criteria = true;
        },
