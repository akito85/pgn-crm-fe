...
import { getProfile, updatePassword } from '../../../../../redux/slices/user_management/profile';
    ...
    const handleSave = async (formValue) => {
        try {
            if (formValue.newPassword === formValue.confirmNewPassword) {
                if (data?.pComplexity === 'true' && validatePassword(formValue.newPassword)) {
                    setIsNotValid(true);
        ...
        if (isNotValid) {
            return (
                <Tooltip
                    ...
                    <Button type={'text'} border={false} icon={<ExclamationCircleOutlined style={{ color: '#0075BF' }} />} />
                </Tooltip>)
        }
    }
                ...
                <Form.Item>
                    <div className={'w-full flex'}>
                        ...
                        <div className={'flex w-full justify-end  gap-2'}>
                            <ButtonComponent type={'submit'} icon={<SVGIcon name="IconButtonClear" width={24} />} onClick={() => { form.resetFields() }}>Clear</ButtonComponent>
                            <ButtonComponent type={'submit'} htmlType={'submit'} border={false}>Submit</ButtonComponent>
                        </div>
                    </div>
                </Form.Item>
            </Form>
