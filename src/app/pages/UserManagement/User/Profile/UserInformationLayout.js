            ...
            <div className={'flex flex-col flex-wrap w-full justify-evenly'}>
                ...
                <div className="w-full grid grid-cols-2">
                    <div className='w-full flex flex-col'>
                        ...
                        <span>{data?.data?.employeeName ? data?.data?.employeeName : ""}</span>
                    </div>
                    <div className='w-full flex flex-col'>
                        <span className="font-semibold text-sm">Primary Position</span>
                        {data?.data?.primaryPosition?.length > 0 ? data?.data?.primaryPosition?.map((index, key) => (
                            <span key={key}>
                                {index?.positionName}
                            </span>
                        )) : ""}
                ...
                <div className="w-full grid grid-cols-2">
                    ...
                    <div className='w-full flex flex-col'>
                        ...
                        {data?.data?.otherPosition?.length > 0 ? data?.data?.otherPosition?.map((index, key) => (
