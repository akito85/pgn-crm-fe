          ...
          <div>
            <Alert
              message={
                <div>
                  <p>
                    Oops, can’t inactive user when there are pending approval...
                  </p>
                  <p>
                    Forward task or Remind the person in charge to immediately
                    finish the approval process and try again
                  </p>
                </div>
              }
            ...
            <TablePaginationNew
              columns={column}
              dataSource={data?.dataTable?.map((item) => ({
                ...item,
                status:
          ...
          <div className="gap-5">
            ...
            >
              <div className="w-auto grid grid-cols-1 mt-10">
                <span
                  className={"text-primary text-xs font-bold uppercase pb-5"}
                >
                  Forward Task
                </span>
                <Form.Item
                ...
                >
                  <SelectComponent>
                    {data?.dataForm?.toPosition?.map((data, index) => (
                      <Select.Option
                        value={data.employeeCodeForward}
                        key={index}
                      >
