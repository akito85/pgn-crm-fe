...
export const columnsAccounting = (
  ...
  },
  {
    ...
    sorter: true,
    width: 180,
    ...makeMergedSearchCol("paymentNumber", rowSpans, search, searchInput, searchedColumn, searchText, handleSearch),
  },
  {
  ...
  },
  {
    ...
    width: 170,
    isClassification: true,
    ...makeSearchCol("transactionType", search, searchInput, searchedColumn, searchText, handleSearch),
  },
  {
    key: "accountNumber",
  ...
  },
  {
    ...
    width: 150,
    isClassification: true,
    ...makeSearchCol("categorySap", search, searchInput, searchedColumn, searchText, handleSearch),
  },
  {
    key: "documentDate",
  ...
  },
  {
    ...
    sorter: true,
    width: 150,
    ...makeMergedSearchCol("profitCenter", rowSpans, search, searchInput, searchedColumn, searchText, handleSearch),
  },
  {
