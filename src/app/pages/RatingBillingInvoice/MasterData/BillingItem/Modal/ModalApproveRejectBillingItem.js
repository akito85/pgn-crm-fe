...
const ModalApproveOrRejectBillingItem = ({
  isOpen,
  header,
  approveOrReject,
  remark,
  ...
  return (
    <ModalApproveOrReject
      ...
      message={`Are you sure you want to ${approveOrReject} this Billing Item named ${id}`}
      width={1000}
      handleCancel={() => {
        handleCancel();
        form.resetFields();
...
const ModalErrorApproveOrRejectBillingItem = ({
  isOpen,
  handleOk = () => {},
  handleCancel = () => {},
  approveOrReject,
