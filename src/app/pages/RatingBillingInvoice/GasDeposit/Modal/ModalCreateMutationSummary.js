...
const ModalCreateMutationSummary = ({
  isOpen,
  handleCancel = () => {},
  handleRefresh = () => {},
  selectedData = {},
  ...
  const {
    ...
    data_currency_options: currencyOptions,
  ...
  return (
    <ModalCustom
      isOpen={isOpen}
      type="confirmation"
      header="Create Mutation Summary"
    ...
    >
      ...
      <Form layout="vertical" form={form} id="formMutationSummary">
        {/* ========== STEP 1: MUTATION SUMMARY FORM ========== */}
        <div
          className={`steps-content my-[20px] ${currentStep !== 0 ? "hidden" : ""}`}
        >
          <BaseContainer
            subHeader={
              <p className="-mt-[10px] text-primary">MUTATION SUMMARY INFORMATION</p>
            }
            border
            className="mb-3"
          >
            ...
            <Form.Item
              ...
              name="balanceVolume"
              rules={[
                { required: true, message: "Please input Balance Volume!" },
              ]}
              getValueFromEvent={(e) => e.floatValue}
            >
              <InputComponent
                type="numeric"
                placeholder="Enter Balance Volume"
                thousandSeparator="."
                decimalSeparator=","
                decimalScale={2}
              />
            ...
            <Form.Item
              ...
              name="balanceAmount"
              rules={[
                { required: true, message: "Please input Balance Amount!" },
              ]}
              getValueFromEvent={(e) => e.floatValue}
            >
              <InputComponent
            ...
            >
              <DateComponent placeholder="Select Start Date" />
            </Form.Item>
            ...
            >
              <DateComponent placeholder="Select End Date" />
            </Form.Item>
            ...
            <Form.Item
              ...
              name="redemPeriod"
              rules={[
                { required: true, message: "Please select Redeem Period!" },
              ]}
            >
              <SelectComponent
                placeholder="Select Redeem Period"
                showSearch
                filterOption={(input, option) =>
                  (option?.children ?? "")
                    .toLowerCase()
...
export default ModalCreateMutationSummary;
