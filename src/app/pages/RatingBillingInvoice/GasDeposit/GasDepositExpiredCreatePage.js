...
const GasDepositExpiredCreatePage = () => {
  ...
  const searchColumns = useMemo(
    () => [
      ...
      { key: "customerName", title: "CUSTOMER NAME", dataIndex: "customerName", width: 120 },
      { key: "accountNumber", title: "ACCOUNT NUMBER", dataIndex: "accountNumber", width: 80 },
      { key: "accountName", title: "ACCOUNT NAME", dataIndex: "accountName", width: 160 },
      {
        key: "expiredAmount",
  ...
  return (
    <>
      ...
      <ModalCustom
        ...
        width={1200}
        footer={[
          <ButtonComponent key="cancel" onClick={() => setIsSearchModalOpen(false)}>
            cancel
          </ButtonComponent>,
          <ButtonComponent key="confirm" type="primary" border={false} onClick={handleConfirmSearch}>
            Confirm
          </ButtonComponent>,
        ]}
      >
