...
const MonitoringUsageUpdate = ( ) => {
    ...
    const handleSave = (formValue) => {
        const selectedSource = data_source.find((source) => source.id === formValue.source);
        const sourceName = selectedSource ? selectedSource.name : "";
        
        const updatedData = {
            ...formValue,
            billingPeriod: moment(formValue.billingPeriod).format("MMM YYYY") || period,
            ...
            fhour: hasValue(formValue.fhour) ? moment(formValue.fhour).format("HH:mm") : hour,
