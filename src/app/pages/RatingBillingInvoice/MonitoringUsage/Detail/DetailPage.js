...
const DetailPage = () => {
    const { detail_batch, loading, updatedData, deletedData } = useSelector((state) => state.monitoring_usage);
        ...
        <LayoutMenu>
            ...
            <Spin spinning={loading}>
                ...
                <Form form={form} onFinishFailed={handleFinishError} onFinish={handleSave} layout='vertical'>
                    {tabHeader === 'Upload' ?
                        <DetailUpload form={form} dataHeader={dataHeader} dataTable={dataTable} setDataTable={setDataTable} id={batchId} /> :
                        <ApprovalLayout type={'detail-approval'} onApprovalChange={setApphierId} selectedAppHierId={apphierId} status={detail_batch?.batchInformation?.status} form={form} />}
