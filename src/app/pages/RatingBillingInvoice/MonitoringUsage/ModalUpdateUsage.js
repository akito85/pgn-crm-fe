  ...
  useEffect(() => {
    if (record) {
      form.setFieldsValue({
        ...
        billingPeriod:
          hasValue(record?.billingPeriod) && moment(record?.billingPeriod),
        ...
        >
          <div className="w-full grid grid-cols-4 gap-4">
            ...
            <Form.Item
              label={"Volume 27"}
              name={"volMeasured27"}
              rules={uploadType === "FINAL" && formMessageRequired("Volume 27")}
              getValueFromEvent={(e) => {
                return e.floatValue;
              }}
            >
            ...
            <Form.Item
              label={"Volume 60"}
              name={"volMeasured60"}
              rules={uploadType === "FINAL" && formMessageRequired("Volume 60")}
              getValueFromEvent={(e) => {
                return e.floatValue;
              }}
            >
