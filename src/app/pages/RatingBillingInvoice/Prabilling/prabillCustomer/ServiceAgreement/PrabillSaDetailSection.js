// File: PrabillSaDetailSection.jsx
...
export const columnsPrabillSaDetail = (
  page = 1,
  pageSize = 10,
  searchInput,
  searchedColumn,
...
const PrabillSaDetailSection = ({ prabillSaId }) => {
  // Selector
...
export default PrabillSaDetailSection;