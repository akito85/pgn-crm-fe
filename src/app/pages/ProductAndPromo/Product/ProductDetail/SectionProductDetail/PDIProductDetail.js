...
const columns = (
  ...
  const result = [
    ...
    },
    {
      ...
      align: "center",
      dataIndex: "unitName",
      filteredValue: search?.["unitName"] ? [search?.["unitName"]] : null,
      // onFilter: (value, record) => onFilter("unitName", value, record),
      sorter: (a, b) => sorter("unitName", a, b),
      // ...getColumnSearchPropsPaging(
      //   "unitName",
      //   searchInput,
      //   searchedColumn,
...
export default PDIProductDetail;
