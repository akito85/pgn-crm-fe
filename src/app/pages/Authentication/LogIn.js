...
const LogIn = (props) => {
  ...
  const { loading, data_entities, isLoggedIn } = useSelector(
    (state) => state.auth,
  );
  ...
  const handleLogin = (formValue) => {
    ...
    if (validateCaptcha(formValue.captcha)) {
      if (type === "superuser") {
        ...
        dispatch(
          login({ user: data, level: type, remember: formValue.remember }),
        );
        ...
        <div className="w-full h-screen flex">
          <div className={`${data?.length === 0 ? "w-full" : "w-2/3"} h-full`}>
            {data?.length > 0 ? (
              ...
              <div className="w-full bg-no-repeat bg-cover h-full">
          ...
          <Card style={{ width: "50%" }} className="card-login">
            ...
            >
              ...
              >
                ...
                >
                  <div
                    className={"flex justify-between mt-4 w-full  item-center"}
                  >
        ...
        <div className={"flex px-8 py-8"}>
          ...
          <div className="w-full flex-col">
            ...
            <div className="pl-4 pt-4">
              {failedCaptcha === true ? (
                <span className={"text-l"}>Captcha Does Not Match</span>
              ) : (
