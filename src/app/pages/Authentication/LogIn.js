...
const LogIn = (props) => {
	...
	// Captcha is enabled by default, only disabled when explicitly set to 'false' in .env.local
	const isCaptchaEnabled = process.env.REACT_APP_CAPTCHA_ENABLED !== 'false';
	useEffect(() => {
