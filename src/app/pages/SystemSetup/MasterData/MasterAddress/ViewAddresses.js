...
const ViewAddresses = () => {
    ...
    const columns = (
        ...
        return [
            ...
            },
            {
                ...
                render: (text) => renderColumn('fullAddress', searchedColumn, searchText, text?.toUpperCase(), true, 'input', search)
            },
            {
                title: "TYPE",
                dataIndex: "type",
            ...
            },
            {
                ...
                render: (text) => renderColumn('building', searchedColumn, searchText, text, false, 'input', search)
            },
            {
                title: "FLOOR",
                dataIndex: "floor",
                ...
                render: (text) => renderColumn('floor', searchedColumn, searchText, text, false, 'input', search)
            },
            {
                title: "HOUSE NAME",
                dataIndex: "houseName",
                ...
                render: (text) => renderColumn('houseName', searchedColumn, searchText, text, false, 'input', search)
            },
            {
                title: "STREET NAME",
                ...
                render: (text) => renderColumn('streetName', searchedColumn, searchText, text, false, 'input', search)
            },
            {
                title: "BLOCK",
                dataIndex: "block",
                ...
                render: (text) => renderColumn('block', searchedColumn, searchText, text, false, 'input', search)
            },
            {
                title: "HOUSE NUMBER",
                ...
                render: (text) => renderColumn('houseNumber', searchedColumn, searchText, text, false, 'input', search)
            },
            {
                title: "RT",
                ...
                render: (text) => renderColumn('neighborhood1', searchedColumn, searchText, text, false, 'input', search)
            ...
            },
            {
                ...
                render: (text) => renderColumn('neighborhood2', searchedColumn, searchText, text, false, 'input', search)
            ...
            },
            {
                ...
                render: (text) => renderColumn('additionalInfo', searchedColumn, searchText, text, true, 'input', search)
    ...
    const handleSaveActivation = async (formValue) => {
        try {
            ...
            const reqSearch = encodeURIComponent(JSON.stringify(search));
            await dispatch(getAddressesPaginate({ page, pageSize, sort, search: reqSearch }))?.unwrap();
            form.resetFields();
        } catch (error) {
            form.resetFields();
            setOpenModal(false);
    ...
    const handleConfirm = () => {
        if (bodyError?.action === 'GET_ADDRESS_PAGINATE') {
            const reqSearch = encodeURIComponent(JSON.stringify(search));
            dispatch(getAddressesPaginate({ page, pageSize, sort, search: reqSearch })).unwrap();
