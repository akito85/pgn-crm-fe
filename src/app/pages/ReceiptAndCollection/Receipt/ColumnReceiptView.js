  ...
  handleDeleteReceipt = (record) => { }
    ...
    },
    {
      ...
      render: (index) => {
        ...
        return renderColumn('isMisc', searchedColumn, searchText, text, false, 'input', search)
      },
    },
    {
      title: "BANK",
    ...
    },
    {
      ...
      render: (text) => renderColumn('paymentCycle', searchedColumn, searchText, text, false, 'input', search)
    ...
    },
    {
      ...
      render: (text) => renderColumn('bankStatementName', searchedColumn, searchText, text, false, 'input', search)
    ...
    },
    {
      ...
      render: (text) => renderDateColumn('bankStatementDate', hasValue(search['bankStatementDate']), searchText, text, 'date', search)
