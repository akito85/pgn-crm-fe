...
const ListFormReverse = () => {
    ...
    const [valuePage, setValuePage] = useState("Adjustment Reverse");
    ...
    const routes = [
        ...
        {
            path: "",
            breadcrumbName: "Create Adjustment Reverse",
        },
    ];
    ...
    const handleSubmitForm = (values) => {
        console.log("Submit Form Values (Reverse):", values);
        setFormData(values);
    ...
    return (
        <div>
            <Spin spinning={loading}>
                ...
                >
                    <div style={{ display: valuePage !== "Adjustment Reverse" ? "none" : undefined }}>
                        <BaseContainer header={"ADJUSTMENT REVERSE INFORMATION"}>
                            <div className="p-4">
                                <ReverseForm form={form} record={record} listType={dataListReverseType} />
                            </div>
                        </BaseContainer>
                    </div>
...
export default ListFormReverse;
