...
import ContentModalConfirmReplace from "./ContentModalConfirmReplace";

const ListFormReplace = () => {
    ...
    const [valuePage, setValuePage] = useState("Adjustment Replace");
    ...
    const routes = [
        ...
        {
            path: "",
            breadcrumbName: "Create Adjustment Replace",
        },
    ];
    ...
    const handleSubmitForm = (values) => {
        console.log("Submit Form Values (Replace):", values);
        setFormData(values);
    ...
    return (
        <LayoutMenu>
            <Spin spinning={loading}>
                ...
                >
                    <div style={{ display: valuePage !== "Adjustment Replace" ? "none" : undefined }}>
                        <BaseContainer header={"ADJUSTMENT REPLACE INFORMATION"}>
                            <div className="p-4">
                                <ReplaceForm form={form} record={record} listType={dataListReplaceType} />
                            </div>
                        </BaseContainer>
                    </div>
...
export default ListFormReplace;
