  ...
  return (
    <div>
      ...
      <div className={"grid grid-cols-3 w-full gap-x-6"}>
        ...
        >
          <SelectComponent mandatory label={"Country"}>
        ...
        >
          <SelectComponent mandatory label={"Province"}>
            <Select.Option key={1} value={1}>
              Person
            </Select.Option>
            <Select.Option key={2} value={2}>
        ...
        >
          <SelectComponent mandatory label={"City"}>
            <Select.Option key={1} value={1}>
              Person
            </Select.Option>
            <Select.Option key={2} value={2}>
        ...
        >
          <SelectComponent mandatory label={"District"}>
            <Select.Option key={1} value={1}>
              Person
            </Select.Option>
            <Select.Option key={2} value={2}>
        ...
        >
          <SelectComponent mandatory label={"Sub District"}>
            <Select.Option key={1} value={1}>
              Person
            </Select.Option>
            <Select.Option key={2} value={2}>
        ...
        >
          <InputComponent mandatory label={"Postal Code"} type="text" />
        </Form.Item>
        <Form.Item
          name={"building"}
          rules={[
        ...
        >
          <InputComponent mandatory label={"Building"} type="text" />
        </Form.Item>
        <Form.Item
          name={"floor"}
          rules={[
        ...
        >
          <InputComponent mandatory label={"Floor"} type="text" />
        </Form.Item>
        <Form.Item
          name={"houseName"}
          rules={[
        ...
        >
          <InputComponent mandatory label={"House Name"} type="text" />
        </Form.Item>
        <Form.Item
          name={"streetName"}
          rules={[
        ...
        >
          <InputComponent mandatory label={"Street Name"} type="text" />
        </Form.Item>
        <Form.Item
          name={"block"}
          rules={[
        ...
        >
          <InputComponent mandatory label={"Block"} type="text" />
        </Form.Item>
        <Form.Item
          name={"houseNumber"}
          rules={[
        ...
        >
          <InputComponent mandatory label={"House Number"} type="text" />
        </Form.Item>
        <Form.Item
          name={"rt"}
          rules={[
        ...
        >
          <InputComponent mandatory label={"RT"} type="text" />
        </Form.Item>
        <Form.Item
          name={"rw"}
          rules={[
        ...
        >
          <InputComponent mandatory label={"RW"} type="text" />
        </Form.Item>
        <Form.Item
          name={"additionalInfo"}
          rules={[
        ...
        >
          <InputComponent mandatory label={"Additional Info"} type="text" />
        </Form.Item>
      </div>
