...
const ContactForm = ({
  ...
  // console.log(data_countryZone, ' country zone');
  // Declaration
  ...
  const columnsDetail = [
    ...
    },
    {
      ...
      render: (_, record, id) => {
        ...
        // console.log(`tempValueOverview ${tempValue} prefixName1 ${prefixName1} prefixName2 ${prefixName2} suffix ${suffix[`${keyModal}~${record.key}`]}`);
        if (record.type === 741) {
  ...
  // console.log(dataTableDetail, ' data table detail');
