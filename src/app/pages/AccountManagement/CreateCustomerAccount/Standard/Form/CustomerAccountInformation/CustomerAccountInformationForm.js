...
const CustomerAccountInformation = ({
  ...
  const [accountRegistrationNumber, setAccountRegistrationNumber] =
    useState("");
          ...
          <div className="w-full grid grid-cols-3 gap-2 pt-[30px]">
            ...
            {CIObj?.customerType === 58 ? (
              <Form.Item
                label={"Customer Name"}
                name={"customerName"}
                getValueFromEvent={(e) => handleCAIObj(e, "customerName")}
                rules={[
                  {
                    required: true,
