...
const TaxIdentifierForm = ({
  ...
  useEffect(() => {
    if (tiObj.taxIdentifierType !== 922 || tiObj.taxIdentifierType !== 921) {
      form.setFieldsValue({
        taxIdentifierType: tiObj.taxIdentifierType,
        taxIdentifierNumber: tiObj?.taxIdentifierNumber,
        taxIdentifierName: tiObj?.taxIdentifierName,
      });
    }
  }, [tiObj]);
  ...
  return (
    <div>
      ...
      <div className="w-full grid grid-cols-3 gap-2 pt-[15px]">
        <Form.Item
