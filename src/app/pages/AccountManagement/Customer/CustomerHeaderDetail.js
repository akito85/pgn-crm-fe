  ...
  const renderSection = () => {
    switch (segmentedPage) {
      case listCustomerPage[0].value:
        return <CustomerInformation data={data_detail} type={data_detail?.customerTypeId}/>;
      case listCustomerPage[1].value:
        return <AttachmentCustomer type={"detail"} id={id} dispatch={dispatch} />;
      default:
        return <></>;
    }
  };
    ...
    <Fragment>
      ...
      >
        <div className="px-5 pt-5 pb-[10px] justify-center">
          ...
          <p className="pl-[70px]">{"You cannot update this customer because your entity/cost center is not registered in this customer assignment"}</p>
        </div>
      </ModalError>
    </Fragment>
  );
