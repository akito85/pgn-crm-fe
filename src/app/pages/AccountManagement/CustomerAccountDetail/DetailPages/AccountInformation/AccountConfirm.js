...
const AccountConfirm = ({ data_header = [], data_detail = {} }) => {
  // useEffect(() => {},[]);
  return (
    <Fragment>
      ...
      <div className="w-full grid grid-cols-3 gap-3">
        <DetailText label="Segment">{data_detail?.accountSegment}</DetailText>
        ...
        <DetailText label="Priority">{data_detail?.priority}</DetailText>
        <DetailText label="Corporate Customer">
          {data_detail?.corporateCustomer ? "Yes" : "No"}
        </DetailText>
      ...
      <div className="w-full grid grid-cols-3 gap-3">
        <DetailText label="Budget Year">{data_detail?.budgetYear}</DetailText>
        <DetailText label="Budget">{data_detail?.budget}</DetailText>
        <DetailText label="Teritory">{data_detail?.teritory}</DetailText>
      </div>
    </Fragment>
  );
};
