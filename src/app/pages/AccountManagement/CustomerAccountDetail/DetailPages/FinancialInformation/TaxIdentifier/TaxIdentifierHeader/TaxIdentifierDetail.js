    ...
    <Fragment>
      <CardComponent header={"TAX IDENTIFIER INFORMATION"}>
        <div className="w-full grid grid-cols-4 gap-3">
          <DetailText label="Tax Identifier Type">{data_detail?.taxIdentifierTypeValue}</DetailText>
          <DetailText label="Tax Identifier Number">{data_detail?.taxIdentifierNumber}</DetailText>
          <DetailText label="Tax Identifier Name">{data_detail?.taxIdentifierName}</DetailText>
          <DetailText label="Status">{data_detail?.status}</DetailText>
          <div className="col-span-3">
            <DetailText label="Tax Identifier Address">{data_detail?.taxIdentifierAddressValue}</DetailText>
          </div>
        </div>
      </CardComponent>
