    ...
    <div>
      ...
      <div className={"grid grid-cols-2 w-full gap-x-6"}>
        <Form.Item
          name={"createFrom"}
          label={"Create From"}
          getValueFromEvent={(e) => handleSaDetailObj(e, "createFrom")}
          rules={[
            {
        ...
        >
          <SelectComponent
            ...
            disabled={saRecordData?.saType === "Amendment"}
          >
          ...
          >
            <div className="flex flex-row">
              <Input.Group compact>
                ...
                {/* <Input value={saDetailObj.productName} disabled={saRecordData?.saType == "Amendment"} /> */}
      ...
      {(isCreateFromTwo || isCreateFromOneWithData || dataDetail) && (
        <>
              ...
              <div className="py-8">
                ...
                <div className={`${valuePage !== "Pricing" ? "hidden" : ""}`}>
                  ...
                  <div className={"grid grid-cols-1 w-full gap-x-6"}>
                    <div>
                      ...
                      <Form.Item
                        ...
                        // rules={[
                        //   {
                        //     message: "Please input your Pricing Rule",
                        //     required: true,
                        //   },
                        // ]}
                        getValueFromEvent={(e) =>
                  ...
                  <TablePricing
                    ...
                    setIdCreateFrom={setIdCreateFrom}
