        ...
        <div className={`${valuePage !== "Service Agreement Information" ? "hidden" : ""}`}>
          <div className="w-full p-5">
            ...
            <div className="grid grid-cols-4 gap-5 pb-[30px]">
              ...
              <DetailText label="Commitment Date">{dataFinal?.saInfo?.commitmentDate ? moment(dataFinal?.saInfo?.commitmentDate).format(dateFormatting.date) : ''}</DetailText>
            </div>
            ...
            <div className="grid grid-cols-4 gap-5 pt-[30px]">
              ...
              <DetailText label="Already Gas In">{dataFinal?.saInfo?.alreadyGasIn ? "Yes" : "No"}</DetailText>
            </div>
          </div>
        </div>
