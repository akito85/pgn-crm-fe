...
const EditableCell = ({
  ...
  const getInputNode = (inputType, options, disabledField) => {
    switch (inputType) {
      case "text":
  ...
  const inputNode = getInputNode(inputType, options, disabledField);
