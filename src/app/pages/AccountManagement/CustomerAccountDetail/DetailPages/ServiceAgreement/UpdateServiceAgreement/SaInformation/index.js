...
const SaInformation = ({
  ...
  const handleDisableSaDate = (current) => {
    if (
      saRecordData.saType === "Addon" ||
      saRecordData.saType === "Amendment"
    ) {
      return (
        current &&
  ...
  const handleValidateMore = (current) => {
    if (
      ...
      return (
        current &&
        (current < moment(saInfoObj.startDate) ||
          current > moment(dataDetail.saInfo.saMainEndDate).add(1, "days"))
      );
    } else {
    ...
    if (
      ...
      if (saInfoObj.startDate !== null && saInfoObj.endDate !== null) {
        return (
          current &&
          (current <= moment(saInfoObj.startDate) ||
            current >= moment(saInfoObj.endDate))
        );
      }
    }
  };
      ...
      <div>
        ...
        <div className={"grid grid-cols-3 w-full gap-x-6"}>
          ...
          >
            <SelectComponent
              disabled={
                saRecordData.status === "ACTIVE" || saRecordData.isMain !== "Y"
                  ? true
                  : false
              }
              onChange={(e) => {
      ...
      <div>
        ...
        {saRecordData.isMain !== "Y" && (
          <div className={"grid grid-cols-3 w-full gap-x-6"}>
            <Form.Item
              ...
              getValueFromEvent={(e) =>
                handleSaInformationObj(e, "serviceAgreementReferenceNumber")
              }
              rules={[
                {
                  message:
                    "Please input your Service Agreement Reference Number",
                  required: true,
                },
              ]}
            >
        ...
        <div className={"grid grid-cols-3 w-full gap-x-6"}>
          <Form.Item
            ...
            getValueFromEvent={(e) =>
              handleSaInformationObj(e, "serviceAgreementNumber")
            }
            rules={[
              {
          ...
          <Form.Item
            ...
            getValueFromEvent={(e) =>
              handleSaInformationObj(e, "serviceAgreementType")
            }
            rules={[
              {
          ...
          <Form.Item
            ...
            getValueFromEvent={(e) =>
              handleSaInformationObj(e, "serviceAgreementDate")
            }
            rules={[
              {
          ...
          >
            <DateComponent
              dateDisable={handleDisableSaDate}
              disabled={saRecordData.status === "ACTIVE" ? true : false}
              onChange={(e) => handleDateValidation(e, "serviceAgreementDate")}
            />
          </Form.Item>
          <Form.Item
            name={"startDate"}
          ...
          >
            <DateComponent
              dateDisable={handleValidateMoreSaDate}
              disabled={saRecordData.status === "ACTIVE" ? true : false}
              onChange={(e) => handleDateValidation(e, "startDate")}
            />
          </Form.Item>
          <Form.Item
            name={"endDate"}
          ...
          >
            <DateComponent
              dateDisable={handleValidateMore}
              onChange={(e) => handleDateValidation(e, "endDate")}
            />
          </Form.Item>
        </div>
      </div>
      ...
      <div>
        ...
        <div className={"grid grid-cols-3 w-full gap-x-6"}>
          ...
          >
            <SelectComponent
              disabled={
                saRecordData.status === "ACTIVE" || saRecordData?.isMain == "N"
                  ? true
                  : false
              }
            >
          ...
          <Form.Item
            ...
            getValueFromEvent={(e) =>
              handleSaInformationObj(e, "termOfPayment")
            }
            rules={[
              {
          ...
          <Form.Item
            ...
            getValueFromEvent={(e) =>
              handleSaInformationObj(e, "invoiceTemplate")
            }
            rules={[
              {
        ...
        <div className={"grid grid-cols-3 w-full gap-x-6"}>
          ...
          >
            <div className="flex flex-col">
              <Checkbox
                checked={saInfoObj?.alreadyGasIn}
                onChange={onChangeChecked}
              >
                Already Gas In
              </Checkbox>
              <span className="pl-[26px] text-[10px]">
                Check if the service agreement is gas in or not
              </span>
            </div>
          </Form.Item>
          <Form.Item
            ...
            getValueFromEvent={(e) =>
              handleSaInformationObj(e, "gasInPlanDate")
            }
            rules={[
              {
          ...
          <Form.Item
            ...
            getValueFromEvent={(e) =>
              handleSaInformationObj(e, "commitmentDate")
            }
            rules={[
              {
                ...
                required:
                  segment === "KI" && saRecordData?.isMain == "Y"
                    ? true
                    : false,
              },
            ]}
          >
            <DateComponent
              dateDisable={handleValidateMoreSaDate}
              onChange={(e) => handleDateValidation(e, "commitmentDate")}
              disabled={
                saRecordData.status === "ACTIVE" || saRecordData?.isMain == "N"
                  ? true
                  : false
