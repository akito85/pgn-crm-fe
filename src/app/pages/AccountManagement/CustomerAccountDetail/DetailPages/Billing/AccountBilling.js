...
const listBillingPage = [{ value: "Postpaid" }, { value: "Prepaid" }];

const AccountBilling = ({ handleChangeInteraction = () => {} }) => {
  ...
  const [segmentedPage, setBillingPage] = useState(listBillingPage[0].value);
