...
const AttachmentRelationship = ({
    ...
    // Use relationship attachment category from Redux
    ...
    const handleShow = async (r) => {
        if (r.dataType !== "exist") {
            ...
            if ((r.fileType || r.type).includes("application/vnd")) {
                // Download for existing files
                FileSaver.saveAs(r.urlFile1, r.fileName);
            } else {
            ...
            <NxPanel title={"ATTACHMENT"} removeBottomMargin>
                <Spin spinning={loadingDownload}>
                    <div className="flex flex-col w-full gap-5">
                        {/* Upload Button Section - show for create and update types */}
